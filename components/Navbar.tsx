...
import { Menu, X, Bell, CheckCircle2, ArrowUpRight, LogIn, LogOut, LayoutDashboard, Settings, User } from 'lucide-react';
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#141820]/95 backdrop-blur-md border-b border-[#1e2632] shadow-xl text-[#f1f5f9]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-14">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            {/* Auth-Aware Avatar / Sign In Control */}
            {user ? (
      ...
      {isOpen && (
        <div className="lg:hidden fixed inset-0 top-14 z-40 bg-[#0c0e12]/90 backdrop-blur-md px-4" onClick={() => setIsOpen(false)}>
          <div 
