...
export default function Home() {
  const [targetTime, setTargetTime] = useState<string>('2026-08-12T03:30:00.000Z');
        ...
        <div className="w-full py-10 px-6 bg-zinc-900/30 border border-zinc-900 rounded-3xl backdrop-blur max-w-2xl mx-auto flex flex-col items-center">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center space-y-2 p-6 bg-zinc-900/50 border border-red-500/20 rounded-2xl max-w-lg mx-auto backdrop-blur">
              ...
              <p className="text-zinc-500 text-xs font-mono mt-1 text-center">DEADLINE WAS 12 AUGUST 2026, 11:30 PM IST</p>
            </div>
          ) : (
          ...
          <div className="mt-8 flex flex-col md:flex-row items-center gap-4 text-xs font-mono font-bold text-zinc-500 border-t border-zinc-800/40 pt-6 w-full justify-center">
            ...
            <div className="flex items-center space-x-1.5">
              ...
              <span>9:00 AM - 11:30 PM IST (Asia/Kolkata)</span>
            </div>
          </div>
        </div>
