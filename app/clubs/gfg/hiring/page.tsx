...
import { ArrowRight, Terminal, Globe, Calendar, ChevronLeft } from 'lucide-react';
import { RECRUITMENT_ROLES } from '@/lib/roles';

export default function GfgHiringPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sansSelection selection:bg-emerald-500/30 selection:text-emerald-400 relative">
      ...
      <div className="w-full max-w-5xl mx-auto px-6 pt-6 z-10">
        <Link 
          href="/clubs/gfg" 
          className="inline-flex items-center space-x-1.5 text-zinc-400 hover:text-white transition-colors text-xs font-bold uppercase tracking-wider font-mono"
        >
          <ChevronLeft className="w-4 h-4" />
          <span>Back to GFG Campus Page</span>
        </Link>
      </div>
